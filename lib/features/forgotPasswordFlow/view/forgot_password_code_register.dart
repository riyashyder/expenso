...
class ForgotPassCodeRegister extends StatefulWidget {
  final String email;
  final String firstName;
  final String lastName;
  final String password;
  final int otpValidityTime;
  const ForgotPassCodeRegister({super.key, required this.email, required this.firstName, required this.lastName, required this.password, required this.otpValidityTime});

  @override
  State<ForgotPassCodeRegister> createState() => _ForgotPassCodeRegisterState();
}

class _ForgotPassCodeRegisterState extends State<ForgotPassCodeRegister> {
                              ...
                              Expanded(
                                child: AppElevatedButton(
                                  ...
                                  onPressed: controller.isOtpComplete && !controller.isLoading
                                    ...
                                    await controller.verifyOtpRegister(context, widget.email, controller.otpControllers, widget);
                                  }
                                      : null,
                                ),
                              )
